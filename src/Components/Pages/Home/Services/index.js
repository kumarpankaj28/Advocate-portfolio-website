  ...
  return (
    <div>
      <section className="mx-auto bg-white ">
        <div className=" flex bg-light dark:bg-gray-800">
          {/* <div className="container px-6 py-8 mx-auto"> */}
            <div className=" flex lg:flex p-24 justify-items-center ">  
              <h1 className=" w-1/2 text-4xl font-bold text-center  pt-4  text- dark:text-gray-400 lg:text-center lg:px-24 uppercase md-w-24">
        ...
        {/* --------------Start Card------->>>>> */}
        <section className="grid grid-cols-1 lg:grid-cols-2 py-10  justify-items-center sm:grid-cols-2 md:w-full">
